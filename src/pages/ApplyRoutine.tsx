    ...
    return (
        <div className="screen applyRoutine-screen justify-between start-screen p-5 flex  flex-col gap-5 min-h-[100dvh]">
            ...
            <h1 className="text-dark text-[1.7rem] font-bold text-center mt-[3vh] p-5">
                Apply BUIE CSE 2nd Sem <span className="-accent">Routine</span>? <br />
            ...
            <p className="text-center text-sm mx-4 text-black/70">Click on 'Apply Routine' to apply <span className="text font-semibold">BUIE CSE Second Semester</span> Routine. You can skip and apply the routine from settings also.</p>
