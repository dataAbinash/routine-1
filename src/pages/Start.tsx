    ...
    return (
        <div className="justify-between start-screen p-5 flex  flex-col gap-5 min-h-[100dvh]">
            ...
            <div className="btnWrapper">
                <button onClick={() => navigate('/applyRoutine', {replace : true})} className="no-highlight select-none rounded-2xl bg-dark text-white w-full mx-auto block p-[1.4em] duration-150 active:scale-[0.98] text-sm">
                    Continue
                </button>
